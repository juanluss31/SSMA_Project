...
class NodeHttpServer {
  constructor(config) {
    ...
    app.post('/api/people-counter', (req, res) => {
      const { right, left } = req.body;
      // console.log(`[DEBUG] Received data: right=${right}, left=${left}`);
      if (typeof right === 'number' && typeof left === 'number') {
        context.stat.right = right;
        context.stat.left = left;
        // console.log(`[DEBUG] Updated stat: ${JSON.stringify(this.stat)}`);
