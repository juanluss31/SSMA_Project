...
const Counter = () => {
  const [cpuOption, setCpuOption] = i.a.useState(B("CPU Usage"));
      ...
      fetch("/api/server", { credentials: "include" })
        ...
        .then((data) => {
          ...
          setCpuOption((prevOption) => {
            ...
            if (!updatedOption.series[0].data) updatedOption.series[0].data = [];
            ...
            updatedOption.series[0].data.push(data.cpu.load || 0);
