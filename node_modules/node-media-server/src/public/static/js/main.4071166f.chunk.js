...
const Counter = () => {
      ...
      fetch("/api/server", { credentials: "include" })
        ...
        .then((data) => {
          ...
          setCpuOption((prevOption) => {
            // Deep clone the previous option
            const updatedOption = JSON.parse(JSON.stringify(prevOption));

            // Ensure xAxis and series arrays are initialized
  ...
  return i.a.createElement(
    "div",
    { style: { margin: "0px -12px;" } , class: "ant-row"},
    i.a.createElement("h1", null, "Counter Section"),
    i.a.createElement("p", null, "This is the Counter section."),
    i.a.createElement("video", {
      class: "ant-col ant-col-12",
      id: "live-stream",
      controls: true,
      autoPlay: true,
      style: { width: "100%", maxWidth: "800px", height: "auto", marginTop: "16px" },
      src: "", // Placeholder for the stream URL, to be updated later
    }),
    i.a.createElement("div", { style: { marginTop: "16px" }, class: "ant-col ant-col-12" },
      i.a.createElement(M.a, {
        echarts: S.a,
        option: cpuOption,
        notMerge: true, // Force chart re-render
        lazyUpdate: false,
