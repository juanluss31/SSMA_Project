...
const Counter = () => {
  ...
  const getSignedUrl = () => {
    if (!password) return videoUrl;
    const hash = F.a.create();
    const expiry = Date.now() + 30000;
    hash.update(`/live/counter-${expiry}-${password}`);
    const signature = hash.hex();
    return `${videoUrl}?sign=${expiry}-${signature}`;
  };
  ...
  return i.a.createElement(
    ...
    i.a.createElement(
      ...
      i.a.createElement(z, {
        url: getSignedUrl(),
        type: "flv",
        style: { width: "100%", maxWidth: "800px", height: "auto", marginBottom: "16px" },
      })
    ),
    i.a.createElement(
      "div",
